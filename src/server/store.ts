...
export function publicSettings(settings: Settings, extras?: { hasWidgetToken?: boolean }): Settings & { hasWidgetToken: boolean } {
  return {
    ...settings,
    sizeCapsGbPerHour: { ...settings.sizeCapsGbPerHour },
    hasWidgetToken: Boolean(extras?.hasWidgetToken),
  };
}
